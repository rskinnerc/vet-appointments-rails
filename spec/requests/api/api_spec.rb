    ...
    path '/doctors/create' do
        ...
        post 'Creates a doctor' do
          ...
          response '200', 'doctor created' do
            let(:doctor) { { name: 'Juan', specialization:'Vet', experience: 5, price: 1.5, description:'Description1'} }
            run_test!
          end
    ...
    path '/doctors/delete' do
        ...
        delete 'Doctor deleted' do
          ...
          response '200', 'doctor deleted' do
            doctor = Doctor.create(name: 'Juan', specialization:'Vet', experience: 5, price: 1.5, description:'Description1')
