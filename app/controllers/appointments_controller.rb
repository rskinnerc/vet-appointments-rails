class AppointmentsController < ApplicationController
  def create
    ...
    @appointment = Appointment.new(user_id: appointment_params[:user_id], doctor_id: appointment_params[:doctor_id],
                                   city: appointment_params[:city], date: DateTime.new(@date[0], @date[1], @date[2], @date[3], @date[4], @date[5]))
